...
describe('MultiSelectComponent', () => {
  ...
  describe('ngOnInit()', () => {
    ...
    xit('should set singleSelected with defaultOption', () => {
      const mockDefaultOption = 'sOmE_defaultOption';
      const mockSingleSelected = {
        id: mockDefaultOption,
        value: 'Some Defaultoption',
        selected: false
      };
      component.defaultOption = mockDefaultOption;
      component.ngOnInit();
      expect(component['singleSelected']).toEqual(mockSingleSelected);
    });
  });
